...
How will you know your skill is working? These are aspirational targets — rough benchmarks rather than precise thresholds. Aim for rigor but accept that there will be an element of vibes-based assessment. Anthropic is actively developing more robust measurement guidance and tooling.
...
- **Workflows complete without user correction** — *How to assess:* Run the same task 3–5 times. Compare outputs for structural consistency and quality.
...
**`description`** (required) — MUST include BOTH:

- What the skill does
- When to use it (trigger conditions)

Plus: under 1024 characters; no XML tags (`<` or `>`); include specific tasks users might say; mention file types if relevant.
...
**Recommended structure** — adapt this template for your skill; replace bracketed sections with your specific content:

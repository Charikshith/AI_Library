...
For implementation details, see: *Skills API Quickstart*, *Create Custom Skills*, and *Skills in the Agent SDK*.

## Recommended approach today

Start by hosting your skill on GitHub with a public repo, a clear README (for human visitors — this is separate from your skill folder, which should **not** contain a `README.md`), and example usage with screenshots. Then add a section to your MCP documentation that links to the skill, explains why using both together is valuable, and provides a quick-start guide.
...
```
"The ProjectHub skill enables teams to set up complete project workspaces in
seconds — including pages, databases, and templates — instead of spending 30
minutes on manual setup."
```
...
```
"Our MCP server gives Claude access to your Linear projects. Our skills teach
Claude your team's sprint planning workflow. Together, they enable AI-powered
project management."
```
